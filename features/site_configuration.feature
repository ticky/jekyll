Feature: Site configuration
  ...
  Scenario: Set time and future dated posts allowed
    ...
    Scenario: Generate proper dates with explicitly set timezone (different than posts' time)
      Given I have a _layouts directory
      And I have a page layout that contains "Page Layout: {{ site.posts.size }}"
      And I have a post layout that contains "Post Layout: {{ content }} published at {{ page.date | date_to_xmlschema }}, built at {{ site.time | date_to_xmlschema }}"
      And I have an "index.html" page with layout "page" that contains "site index page"
      And I have a configuration file with:
        | key         | value                   |
        | time        | 2016-07-11 06:00 +11:00 |
    ...
    And the _site directory should exist
      ...
      And I should see "Post Layout: <p>content for entry1.</p>\n published at 2013-04-09T23:22:00\+04:00, built at 2016-07-11T06:00:00\+11:00" in "_site/2013/04/09/entry1.html"
      And I should see "Post Layout: <p>content for entry2.</p>\n published at 2013-04-10T03:14:00\+04:00, built at 2016-07-11T06:00:00\+11:00" in "_site/2013/04/10/entry2.html"
